...
model.add(Dense(n_feats*2, input_dim=n_feats))
...
# plot_model(model, to_file='output/keras_ELU_deeper.png')

# model path for saving model
previous_model_path = 'output/nomodel.h5'
model_path = 'output/keras_ELU_deeper.h5'
...
plt.savefig('output/r2_keras_ELU_deeper.png')
...
filename = 'sub' + str(count) + '_keras_ELU_deeper' + '.csv'
